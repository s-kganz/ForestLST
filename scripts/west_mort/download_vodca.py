...
if os.path.exists(temp_dir) and len(os.listdir(temp_dir)):
    print("Temporary directory is not empty, skipping unzip step")
else:
    print("Extracting summer VOD images from archive")
    # This command uses curly brace expansion to get all the files in July, August, and September.
    # Doubling the braces makes python's string formatter ignore it.
